...
function renderLayout(activeKey, adminName, adminDepartment) {
  ...
  const menu = [
    ...
    { key: "evaluations", label: "우수학생 평가", href: "evaluations.html", section: "학생평가" },
    // 학과별 정원 설정은 "전체 관리자"만 볼 수 있습니다 (담당 학과가 지정된 학부과장 계정에는 숨김)
    ...(!adminDepartment ? [{ key: "dept-quota", label: "학과별 인원 설정", href: "dept-quota.html", section: "학생평가" }] : []),
  ];
